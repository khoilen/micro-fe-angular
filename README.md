...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/Clmo7F8EsL)
...
```sh
npx nx serve micro-fe-angular-demo
```

To create a production bundle:

```sh
npx nx build micro-fe-angular-demo
```

To see all available targets to run for a project, run:

```sh
npx nx show project micro-fe-angular-demo
```
